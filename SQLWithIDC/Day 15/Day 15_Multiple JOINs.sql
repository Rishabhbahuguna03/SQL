-- Practice questions:
-- Q.1. Join patients, staff, and staff_schedule to show patient service and staff availability.
...
-- Q.2. Combine services_weekly with staff and staff_schedule for comprehensive service analysis.
...
-- Q.3. Create a multi-table report showing patient admissions with staff information.
