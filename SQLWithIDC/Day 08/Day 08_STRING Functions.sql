-- Practice questions:
-- Q.1. Convert all patient names to uppercase.

SELECT UPPER(name) AS name_uppercase
FROM patients;

-- Q.2. Find the length of each staff member's name.

SELECT staff_name, LENGTH(staff_name) AS name_length
FROM staff;

-- Q.3. Concatenate staff_id and staff_name with a hyphen separator.

SELECT CONCAT(staff_id, '-', staff_name) AS staff_identifier
FROM staff;


-- Day 08 Challenge Question:
