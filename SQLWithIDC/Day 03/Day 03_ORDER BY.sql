-- Practice questions:
-- Q.1. List all patients sorted by age in descending order.

SELECT name, age
FROM patients
ORDER BY age DESC;

-- Q.2. Show all services_weekly data sorted by week number ascending and patients_request descending.
...
-- Q.3. Display staff members sorted alphabetically by their names.
