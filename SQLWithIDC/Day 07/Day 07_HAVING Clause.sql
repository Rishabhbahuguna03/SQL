-- Practice questions:
-- Q.1. Find services that have admitted more than 500 patients in total.
...
-- Q.2. Show services where average patient satisfaction is below 75.
...
-- Q.3. List weeks where total staff presence across all services was less than 50.

SELECT week, 
       SUM(present) AS total_staff_members
FROM staff_schedule
GROUP BY week
HAVING SUM(present) < 50;


-- Day 07 Challenge Question:
